...
public class QuestionDAO {
    ...
    public void update(Question obj) {
        ...
        String sql = "UPDATE question SET "
                + "question=?, answer=? WHERE id_question=?";
        try {
            PreparedStatement pstmt = connection.prepareStatement(sql);
            pstmt.setString(1, obj.getQuestion());
            pstmt.setString(2, obj.getAnswer());
            pstmt.setInt(3, obj.getId_question());
    ...
    public Question alea() {
        ...
        public void addGraphics(Question obj, String question, String answer) {
        String sql = "INSERT INTO question (question, answer)"
                + "VALUES (?,?)";
        try {
            PreparedStatement pstmt = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
